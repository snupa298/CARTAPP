...
const UserOrderDetailsPageComponent = ({ userInfo, getUser, getOrder, loadScript,loadPayPalScript }) => {
           ...
           if (data.isPaid) {
              ...
              if (data.paymentMethod === "pp") {
                 ...
                 // setOrderButtonMessage("Wait for your order. You pay on delivery");
                  setOrderButtonMessage("Order Placed. You pay on delivery");
              }
           }
    ...
    const orderHandler = () => {
        ...
        //         // "AWQyyUtcGDgg3XtPQPdn-BNKYgV9NRJ3Dl9ngQL4ygGt8yNBTB13C-Z7OHdOxPSiexd-At1r7hiKK5Jk"})
        //         // .then(paypal => {
        //         //     //console.log(paypal);
